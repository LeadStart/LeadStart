  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="relative overflow-hidden rounded-[12px] p-5 sm:p-7 text-[#0f172a] mt-3" style={{ background: '#EDEEFF', border: '1px solid #e2e8f0', borderTop: '1px solid #e2e8f0', boxShadow: 'none' }}>
