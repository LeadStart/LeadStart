...
export const ENRICH_RUN_COLUMNS =
  ...
  "waterfall_config, " +
  "run_profiles, run_domains, run_waterfall, run_activity, run_verify, phase, status, total_count, " +
  "phase_total_count, processed_count, found_emails_profiles_count, found_domains_count, " +
  "found_emails_waterfall_count, found_emails_count, found_activity_count, found_verified_count, cost_usd, " +
