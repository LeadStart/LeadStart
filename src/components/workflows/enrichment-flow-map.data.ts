...
export const MAPS_NODES: FlowNode[] = [
  ...
  { id: "pm", kind: "box", x: 30, y: 578, w: 220, h: 96, tone: "stepV",
    lines: [{ t: `Waterfall · ${DEFAULT_METHOD}`, s: "titleSm" }, { t: "guess owner email + MV", s: "actor" }, { t: "ok → email conf 85", s: "muted" }, { t: "miss → site_scrape", s: "muted" }, { t: `catch-all → Findymail ${ADDONS.validate_catch_all ? "(add-on, on)" : "(add-on)"}`, s: "opt" }] },
...
export const MAPS_EDGES: FlowEdge[] = [
  ...
  { pts: [[140, 674], [140, 682], [290, 682], [290, 700]] },
