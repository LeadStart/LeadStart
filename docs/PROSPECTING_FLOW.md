...
| **naming** | decision-maker `enrichBusiness` — L1 reads the site, L2 web-search (Perplexity or Claude) ([`decision-maker/index.ts:68`](../src/lib/decision-maker/index.ts)) | name-less, company-named, no email ([`route.ts:2418-2432`](../src/app/api/cron/run-apify-enrichment/route.ts)) | owner name + title | Perplexity ~$0.015 / Claude web-search ~$0.06 |
